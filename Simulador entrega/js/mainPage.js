...
// Recuperar carrito pasado
/* 
let carritoEnLS = JSON.stringify(localStorage.getItem('carritoDeCompras'))

if (carritoEnLS) {
    carritoDeCompras = carritoEnLS
}

rendercarritoDeCompras ( carritoDeCompras )
 */
...
let almacenados = JSON.stringify(localStorage.getItem('listaStock'));
let stockProds = [];

for (const objeto of almacenados)
    stockProds.push(new stock(objeto));
